...
public class Project extends JFrame implements ActionListener{
    ...
    Project(String meter, String person){
        ...
        JMenuItem m5 = new JMenuItem("Search Details");
        ...
        ImageIcon icon13 = new ImageIcon(ClassLoader.getSystemResource("icon/icon13.png"));
        Image image13 = icon13.getImage().getScaledInstance(20, 20,Image.SCALE_DEFAULT);
        m5.setIcon(new ImageIcon(image13));
        m5.setMnemonic('S');
        m5.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S, ActionEvent.CTRL_MASK));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        }else if(msg.equals("Search Details")){
